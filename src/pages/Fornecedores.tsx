      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {estadosDisponiveis.length > 0 && (
            <div className="flex items-center gap-1.5 bg-surface-0 border border-surface-3 rounded-lg px-2 py-1 shadow-card">
              <MapPin className="w-3.5 h-3.5 text-text-tertiary flex-shrink-0" />
              <select
                value={estadoFilter}
                onChange={e => setEstadoFilter(e.target.value)}
                className="font-body text-sm text-text-primary bg-transparent focus:outline-none pr-1 cursor-pointer"
              >
            ...
            <table className="w-full">
              ...
              <tbody>
                {loading ? (
                  ...
                  filtered.map(f => {
                    const localizacao = [f.cidade, f.estado].filter(Boolean).join(', ');
                    return (
                        ...
                        <td className="px-5 py-3.5">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              {localizacao ? (
                                <p className="font-data text-xs text-text-tertiary flex items-center gap-1">
