...
import {
  ...
  Settings, LayoutDashboard, DoorOpen, Zap, Home, Receipt, FileText,
  ChevronDown, Loader2, ToggleLeft, ToggleRight,
} from 'lucide-react';
...
type ConfigTab = 'usuarios' | 'permissoes';
      ...
      <div className="p-6 space-y-5">
        ...
        <div className="flex items-end justify-between gap-3 flex-wrap">
          <div>
            ...
            <p className="font-body text-sm text-text-tertiary mt-1">Gerencie usuários e defina quais telas cada um pode acessar</p>
          </div>
        </div>

        {/* Tabs */}
        <div className="flex items-center gap-1 bg-surface-1 rounded-xl p-1 border border-surface-2 w-fit">
          <button
